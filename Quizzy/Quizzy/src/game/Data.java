...
public class Data 
{
	...
	static String[] carta = {"O que significa 'canastra limpa' no jogo de Canastra?",
			...
			"Sobre Canastra, é afirmado que: “O _____ fica virado para baixo no início da partida, e os jogadores pegam essas cartas para continuar a formar combinações quando acabam com as cartas na mão.” Qual o nome desse monte de cartas?",
	...
	static int[] t = {2,2,1,1,1,1,2,2,2,2,0,2,2,1,2};
	static String[] C = {"Uma canastra com todos os naipes iguais", "Uma canastra sem coringas","Uma canastra feita com as primeiras 11 cartas recebidas no início do jogo",
			...
			"Quatro cartas são viradas para cima na mesa e as restantes formam o monte de compras, os jogadores começam sem nenhuma carta.",
	...
	static String[] J = {"Totodile, Chikorita e Cyndaquil","Treecko, Torchic, Mudkip","Chimchar, Turtwig, Piplup",
			...
			"Yataro Iwasaki","Hideo Kojima","Masaru ibuka","パナソニック株式会社","Nuki","Essei","Justin Wong","Daigo Umehara","Tikomi nakama"};
